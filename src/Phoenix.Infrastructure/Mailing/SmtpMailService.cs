...
public class SmtpMailService : Phoenix.Application.Common.Mailing.IMailService
{
    private readonly MailConfig _settings;
    private readonly ILogger<SmtpMailService> _logger;

    public SmtpMailService(IOptions<MailConfig> settings, ILogger<SmtpMailService> logger)
    {
